...
export const metadata: Metadata = {
  ...
  description: "暮らしの困りごと別に確認手順と役立つスマホアプリを案内します。",
...
export default function ProblemsIndex() {
  return <main className="guide-page">
    ...
    <section className="guide-hero"><span className="overline">APP GUIDES</span><h1>困りごとから、使えるアプリを探す。</h1><p>今起きている状況ごとに、最初にすること、使えるスマホアプリ、注意点をまとめています。</p></section>
