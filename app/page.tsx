...
type GamePick = { id: string; name: string; label: string; description: string; fit: string; caution: string; official: string; ios: string; android: string; icon?: string; preview?: string; accent: string; mark: string };
const gamePicks: GamePick[] = [
  { id: "solo", name: "どうぶつの森 ポケットキャンプ コンプリート", label: "ひとりで、ゆっくり続けたい", description: "キャンプ場づくりやどうぶつとの交流を、自分のペースで楽しむ買い切りアプリ。", fit: "対戦や毎日の課金を気にせず、ひとりで少しずつ遊びたい", caution: "有料アプリです。端末要件と保存データの扱いを公式情報で確認してください。", official: "https://ac-pocketcamp.com/ja-JP", ios: "https://apps.apple.com/jp/app/id6547834967", android: "https://play.google.com/store/apps/details?id=com.nintendo.zasa", icon: "https://is1-ssl.mzstatic.com/image/thumb/Purple211/v4/2e/d8/cb/2ed8cbc4-e7dc-ec02-bfa3-e4f5641c9a97/AppIcon-1x_U007emarketing-0-7-0-85-220-0.png/512x512bb.jpg", preview: "https://is1-ssl.mzstatic.com/image/thumb/PurpleSource221/v4/06/63/bf/0663bfa4-15a0-d423-3988-35abe1384b59/SMDP_ZAS_appSS_1290x2796_250128_JP_A.png/320x480bb.jpg", accent: "#55a778", mark: "PC" },
  { id: "farm", name: "Stardew Valley 「スターデューバレー」", label: "少しずつ、自分の世界を育てたい", description: "農場づくり、採掘、釣りなどを自分のペースで進める買い切りの農場系RPG。", fit: "毎日短い時間でも、ひとつの世界をじっくり育てていきたい", caution: "有料アプリです。端末要件と対応言語をストアで確認してください。", official: "https://www.stardewvalley.net/", ios: "https://apps.apple.com/jp/app/stardew-valley-%E3%82%B9%E3%82%BF%E3%83%BC%E3%83%87%E3%83%A5%E3%83%BC%E3%83%90%E3%83%AC%E3%83%BC/id1406710800", android: "https://play.google.com/store/apps/details?id=com.chucklefish.stardewvalley", icon: "https://is1-ssl.mzstatic.com/image/thumb/Purple211/v4/0e/df/12/0edf1230-3f6e-fbb3-7f72-f2aa844d100a/AppIcons-0-0-1x_U007emarketing-0-8-0-85-220.png/512x512bb.jpg", preview: "https://is1-ssl.mzstatic.com/image/thumb/Purple211/v4/c7/ea/bc/c7eabc7a-3935-3728-ac58-818e6ce497ff/mzl.dkhcxjgr.png/406x228bb.png", accent: "#c98542", mark: "SV" },
  { id: "together", name: "Sky 星を紡ぐ子どもたち", label: "誰かと、ゆるく協力したい", description: "空の王国を旅しながら、ほかのプレイヤーと協力して進むソーシャルアドベンチャー。", fit: "勝敗より、景色や協力プレイを楽しみたい", caution: "オンライン要素とアプリ内課金があります。年齢区分・通信量もストアで確認してください。", official: "https://www.thatskygame.com/ja", ios: "https://apps.apple.com/jp/app/id1462117269", android: "https://play.google.com/store/apps/details?id=com.tgc.sky.android", icon: "https://is1-ssl.mzstatic.com/image/thumb/Purple211/v4/bf/ae/9d/bfae9df0-63ab-7735-1443-3ae021ba9e03/AppIcon-0-0-1x_U007emarketing-0-5-0-85-220.png/512x512bb.jpg", preview: "https://is1-ssl.mzstatic.com/image/thumb/PurpleSource221/v4/8c/46/80/8c4680f5-ae13-734b-47b3-cce474405b93/1.png/406x228bb.png", accent: "#6d8ee8", mark: "SK" },
  { id: "race", name: "マリオカート ツアー", label: "短時間で、対戦レースを楽しみたい", description: "スマホでレースを楽しめるマリオカート。フレンドや近くの人を含む最大8人のマルチプレイに対応しています。", fit: "すきま時間のレースも、友だちとの対戦も楽しみたい", caution: "ニンテンドーアカウントとインターネット通信が必要です。アプリ内課金もあります。", official: "https://mariokarttour.com/ja-JP", ios: "https://apps.apple.com/jp/app/%E3%83%9E%E3%83%AA%E3%82%AA%E3%82%AB%E3%83%BC%E3%83%88-%E3%83%84%E3%82%A2%E3%83%BC/id1293634699", android: "https://play.google.com/store/apps/details?id=com.nintendo.zaka", icon: "https://is1-ssl.mzstatic.com/image/thumb/Purple211/v4/47/48/c0/4748c061-b137-af00-38f5-5ce0d223b522/AppIcon-1x_U007emarketing-0-8-0-85-220-0.png/512x512bb.jpg", preview: "https://is1-ssl.mzstatic.com/image/thumb/PurpleSource112/v4/6f/9e/2b/6f9e2b7d-c693-2412-d17e-cd2b0ebbf358/18a5f24c-02eb-48f8-9b1f-136de5a9b9b1_000_iphone6Plus_ja_@31ca48b87cd973d816b1aca121a1248a9f4a27c9@.png/392x696bb.png", accent: "#df4f56", mark: "MK" },
  { id: "walk", name: "Pokémon GO", label: "散歩のきっかけがほしい", description: "現実の場所を歩きながらポケモンを見つけ、集めて遊ぶ位置情報ゲーム。", fit: "外出や散歩に小さな目的をつくりたい", caution: "歩きスマホはせず、周囲の安全と位置情報・通信量を確認して利用してください。", official: "https://www.pokemongo.jp/download/", ios: "https://apps.apple.com/jp/app/pok%C3%A9mon-go/id1094591345", android: "https://play.google.com/store/apps/details?id=com.nianticlabs.pokemongo", icon: "https://is1-ssl.mzstatic.com/image/thumb/Purple221/v4/1e/0d/a8/1e0da8c5-c56a-68ef-601f-33078883892c/AppIcon-0-0-1x_U007emarketing-0-8-0-85-220.png/512x512bb.jpg", preview: "https://is1-ssl.mzstatic.com/image/thumb/PurpleSource114/v4/eb/a1/3f/eba13f53-7be5-6655-319c-0cffef17ea6f/c37e0b2f-174d-4155-b75e-0d405343601c_Pokemon_iPhone6-8_Screen1_JP.png/392x696bb.png", accent: "#e95b55", mark: "GO" },
  { id: "bloom", name: "Pikmin Bloom", label: "歩いた日を、ゆるく残したい", description: "歩いてピクミンを育てながら、写真や文章でその日の出来事を記録できる位置情報ゲーム。", fit: "散歩を急かされず、日々の記録も楽しみながら続けたい", caution: "位置情報と通信を利用します。周囲の安全を確認して利用してください。", official: "https://pikminbloom.com/ja/", ios: "https://apps.apple.com/jp/app/pikmin-bloom/id1556357398", android: "https://play.google.com/store/apps/details?id=com.nianticlabs.pikmin", icon: "https://is1-ssl.mzstatic.com/image/thumb/Purple211/v4/43/46/87/43468754-513c-9b1a-51d1-87966e4b9e3a/AppIcon-0-0-1x_U007emarketing-0-8-0-85-220.png/512x512bb.jpg", preview: "https://is1-ssl.mzstatic.com/image/thumb/PurpleSource221/v4/a4/6d/de/a46ddea1-4c2e-6545-ae8e-316a6452851f/IUA-576_ASO-Design-UW-FLOWER_JP_1290x2796_NA_C1_V1_STATIC_Evergreen.jpg/320x480bb.jpg", accent: "#6fba64", mark: "PB" },
  { id: "group", name: "Among Us", label: "友だちと短時間で盛り上がりたい", description: "4〜15人で役割を推理しながら遊ぶ、オンラインまたはローカルWi-Fi対応のゲーム。", fit: "通話や集まりで、会話しながら遊べるゲームを探している", caution: "オンラインで知らない人と遊ぶ場合があります。年齢区分、広告・課金をストアで確認してください。", official: "https://www.innersloth.com/games/among-us/", ios: "https://apps.apple.com/jp/app/among-us/id1351168404", android: "https://play.google.com/store/apps/details?id=com.innersloth.spacemafia", icon: "https://is1-ssl.mzstatic.com/image/thumb/Purple211/v4/57/dc/f8/57dcf861-9c14-e964-6f5b-09f8c4fff8d2/AppIcon-0-0-1x_U007emarketing-0-8-0-85-220.png/512x512bb.jpg", preview: "https://is1-ssl.mzstatic.com/image/thumb/PurpleSource115/v4/b7/fe/e6/b7fee60c-2041-1c0e-d3e8-2ca0cef98d36/a4309b28-453c-4b12-89fb-8f4eb3f4b7d3_RoleScreen.png/406x228bb.png", accent: "#54438d", mark: "AU" },
];
  ...
  return (
    <main>
            ...
            <div className={`problem-layout ${visibleProblems.length === 1 ? "single-problem" : ""}`}>
              ...
              <article className="detail-panel">
                ...
                <div className="service-list">{selected.services.map((service, index) => {
                  ...
                  <div className="service-rank">0{index + 1}</div><div className="service-visuals"><AppStoreVisual name={service.name} accent={service.accent} /></div>
      ...
      <section className="game-lab" aria-labelledby="game-lab-title">
        <div className="game-lab-heading"><div><span>PLAY LAB · 試験運用</span><h2 id="game-lab-title">ゲームアプリを、条件から選ぶ。</h2></div><p>生活アプリとは別の特集です。ひとりで続ける・歩く・友だちと遊ぶなど、いまの気分から一本を選べます。</p></div>
        <p className="game-lab-note"><span>{gamePicks.length}つの条件で掲載</span> 課金・通信・年齢区分などは、始める前に公式サイトとストアで確認してください。</p>
        ...
        <article className="game-pick-card">{selectedGamePick.icon ? <img className="game-pick-icon" src={selectedGamePick.icon} alt={`${selectedGamePick.name}のアプリアイコン`} /> : <span className="game-pick-mark" style={{ backgroundColor: selectedGamePick.accent }} aria-label={`${selectedGamePick.name}の識別マーク`}>{selectedGamePick.mark}</span>}<div className="game-pick-main"><span>この条件なら</span><h3>{selectedGamePick.name}</h3><p>{selectedGamePick.description}</p><strong>{selectedGamePick.fit}</strong><small>注意：{selectedGamePick.caution}</small></div>{selectedGamePick.preview ? <figure className="game-preview"><img src={selectedGamePick.preview} alt={`${selectedGamePick.name}の公式ストア画面イメージ`} /><figcaption>公式ストアの画面イメージ</figcaption></figure> : <div className="game-preview game-preview-placeholder" style={{ "--game-accent": selectedGamePick.accent } as React.CSSProperties} aria-label={`${selectedGamePick.name}の案内カード`}><span>PLAY</span><b>{selectedGamePick.mark}</b><small>公式サイト・ストアで<br />画面と利用条件を確認</small></div>}<div className="game-pick-links"><a href={selectedGamePick.official} target="_blank" rel="noreferrer">公式サイト <span>↗</span></a><a href={selectedGamePick.ios} target="_blank" rel="noreferrer">App Store <span>↗</span></a><a href={selectedGamePick.android} target="_blank" rel="noreferrer">Google Play <span>↗</span></a></div></article>
      </section>
