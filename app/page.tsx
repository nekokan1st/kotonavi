  ...
  return (
    <main>
      ...
      <section className="game-lab" aria-labelledby="game-lab-title">
        ...
        <article className="game-pick-card"><img className="game-pick-icon" src={selectedGamePick.icon} alt={`${selectedGamePick.name}のアプリアイコン`} /><div className="game-pick-main"><span>この条件なら</span><h3>{selectedGamePick.name}</h3><p>{selectedGamePick.description}</p><strong>{selectedGamePick.fit}</strong><small>注意：{selectedGamePick.caution}</small></div><figure className="game-preview"><img src={selectedGamePick.preview} alt={`${selectedGamePick.name}の公式ストア画面イメージ`} /><figcaption>公式ストアの画面イメージ</figcaption></figure><div className="game-pick-links"><a href={selectedGamePick.official} target="_blank" rel="noreferrer">公式サイト <span>↗</span></a><a href={selectedGamePick.ios} target="_blank" rel="noreferrer">App Store <span>↗</span></a><a href={selectedGamePick.android} target="_blank" rel="noreferrer">Google Play <span>↗</span></a></div></article>
      </section>
