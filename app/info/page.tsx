    ...
    <main className="policy-page">
      ...
      <div className="policy-content">
        <section id="about">
          ...
          <p>コトナビは、生活上の困りごとを「解決までのステップ」に整理し、その場面で役立つスマホアプリへの入口を提供する情報サイトです。アプリの提供・サポートは、それぞれの運営事業者が行います。</p>
          <dl><dt>運営主体</dt><dd>コトナビ編集部</dd><dt>屋号</dt><dd>コトナビ</dd><dt>運営開始</dt><dd>2026年</dd><dt>サイトの目的</dt><dd>困りごとから適切な行動とスマホアプリを見つけやすくすること</dd></dl></div>
        </section>

        <section id="team">
          <span className="policy-number">02</span><div><h2>コトナビ編集部と情報の確認方法</h2>
          <p>コトナビ編集部は、生活上の困りごとを、利用者が次の行動へ移りやすい順番に整理します。紹介文はアプリ提供者の広告文を転載せず、公式情報から確認できる範囲を利用場面に合わせて編集します。</p>
          <ol><li>困りごとと、最初に確認すべき事項を定義します。</li><li>アプリの公式サイト、App Store、Google Playを確認します。</li><li>対象者、料金、対応OS、利用条件、注意点を照合します。</li><li>アプリだけで解決できない緊急時は、専門窓口を優先する旨を補足します。</li><li>公開後もストア掲載や提供状況を定期確認し、変更時に修正します。</li></ol>
          <dl><dt>執筆・確認</dt><dd>コトナビ編集部</dd><dt>公開用メール</dt><dd><a href="mailto:kotonavi.info@proton.me">kotonavi.info@proton.me</a></dd><dt>主な情報源</dt><dd>アプリ公式サイト、App Store、Google Play</dd></dl></div>
        </section>

        <section id="editorial">
          <span className="policy-number">02</span><div><h2>編集方針</h2>
          <p>掲載候補はスマホアプリに限定し、利用場面との適合性、個人が利用できること、公式サイトまたは公式ストアで情報を確認できることを基準に選定します。</p>
